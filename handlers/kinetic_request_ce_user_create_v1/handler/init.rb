...
class KineticRequestCeUserCreateV1
  ...
  def execute
    ...
    space_admin     = @parameters['space_admin'].downcase == "yes"
    ...
    begin
      ...
      results = JSON.parse(response)["user"]
    ...
    <results>
      ...
      <result name="Username">#{escape(results["username"])}</result>
    </results>
    RESULTS
  end
