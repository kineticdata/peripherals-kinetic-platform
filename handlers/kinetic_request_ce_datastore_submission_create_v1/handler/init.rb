...
class KineticRequestCeDatastoreSubmissionCreateV1
  ...
  def execute
    ...
    begin
      api_route = "#{server}/app/api/v1/datastore/forms/#{form_slug}/submissions"
      ...
      puts "DATASTORE SUBMISSION: #{submission.inspect}"
