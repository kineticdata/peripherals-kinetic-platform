...
class KineticDiscussionsDiscussionRelatedItemAddV1
  ...
  def execute
    ...
    resource = RestClient::Resource.new("#{@discussions_api_url}/v1/discussions/#{@parameters['guid']}/relatedItems")
    related_item = {
      "key" => @parameters['key'],
      "type" => @parameters['type']
    }
    result = resource.post(related_item.to_json, { accept: :json, content_type: :json, authorization: "Bearer #{auth_token}" })
