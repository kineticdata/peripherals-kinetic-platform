...
class KineticDiscussionsDiscussionCreateV1
  ...
  def execute
    ...
    begin
      ...
      puts discussion_data.to_json

      resource = RestClient::Resource.new(@discussions_api_url + "/v1/discussions")
      result = resource.post(discussion_data.to_json, { accept: :json, content_type: :json, authorization: "Bearer #{auth_token}" })
