...
class KineticRequestCeDatastoreSubmissionSearchV1
  ...
  def execute
    ...
    begin
      ...
      puts "Attempting to retrieve datastore submissions" if @enable_debug_logging
      response = resource.get
      puts "Datastore Submissions successfully retrieved. Now attempting to parse." if @enable_debug_logging
